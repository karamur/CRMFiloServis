...
/// <summary>
/// Para birimi ve sayý formatlama yardýmcý sýnýfý
/// </summary>
public static class ParaFormat
{
    ...
    /// <summary>
    /// Decimal deðeri para formatýnda döner (1.234,56 ?)
    /// </summary>
    ...
    /// <summary>
    /// Decimal deðeri kýsa para formatýnda döner (1.234 ?)
    /// </summary>
    ...
    /// <summary>
    /// Decimal deðeri TL koduyla döner (1.234,56 TL)
    /// </summary>
    ...
    /// <summary>
    /// Decimal deðeri kýsa TL koduyla döner (1.234 TL)
    /// </summary>
    ...
    /// <summary>
    /// Nullable decimal deðeri formatlar
    /// </summary>
    ...
    /// <summary>
    /// Nullable decimal deðeri kýsa formatlar
    /// </summary>
