...
/// <summary>
/// Fatura hazýrlýk listesi - Kesilecek ve gelecek faturalarýn özeti
/// </summary>
public class FaturaHazirlikListesi
{
    ...
    /// <summary>
    /// Müþterilere kesilecek faturalar (Satýþ)
    /// </summary>
    public List<KesilecekFaturaItem> KesilecekFaturalar { get; set; } = new();

    /// <summary>
    /// Tedarikçilerden gelecek faturalar (Alýþ - Kira, Komisyon)
    /// </summary>
...
/// <summary>
/// Müþteriye kesilecek fatura kalemi
/// </summary>
...
/// <summary>
/// Kesilecek fatura detayý - Güzergah bazlý
/// </summary>
...
/// <summary>
/// Tedarikçiden gelecek fatura kalemi (Kira veya Komisyon)
/// </summary>
...
public class SeferOzet
{
    ...
    public decimal HesaplananTutar { get; set; } // Kira veya komisyon tutarý
}
